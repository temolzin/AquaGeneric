...
<body class="bg-aqua-light min-h-screen flex items-center justify-center font-sans antialiased">
    <div class="max-w-xl w-full text-center px-6 py-12 flex flex-col items-center">
        ...
        <span class="mt-4 text-4xl font-extrabold tracking-tight text-slate-500">500</span>
        <h1 class="mt-2 text-3xl font-extrabold tracking-wider text-aqua-dark sm:text-4xl uppercase">
            Error Interno
        </h1>
        <p class="mt-4 text-base font-medium text-slate-600 max-w-md uppercase leading-relaxed text-center">
            {{ $exception->getMessage() ?: 'Lo sentimos, algo salió mal en nuestros servidores. Ya estamos trabajando
            para solucionarlo.' }}
        </p>
