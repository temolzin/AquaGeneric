...
<body class="bg-aqua-light min-h-screen flex items-center justify-center font-sans antialiased">
    <div class="max-w-xl w-full text-center px-6 py-12 flex flex-col items-center relative">
        ...
        <span class="mt-4 text-4xl font-extrabold tracking-tight text-slate-500">403</span>
        <h1 class="mt-1 text-3xl font-extrabold tracking-wider text-aqua-dark sm:text-4xl uppercase">
            Acceso Restringido
        </h1>
        <h1 class="mt-4 text-base font-medium text-slate-500 max-w-md uppercase leading-relaxed text-center">
