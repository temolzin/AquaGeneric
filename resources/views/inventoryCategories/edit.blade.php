                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <select name="color" class="form-control @error('color') is-invalid @enderror" id="colorSelect{{ $category->id }}" required>
                                            ...
                                            <div class="input-group-append">
                                                <span class="input-group-text color-preview" id="colorPreview{{ $category->id }}" style="width: 40px; background-color: {{ $category->color }}; border: 1px solid {{ $category->color }};"></span>
                                            </div>
                                        </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        $('[id^="editInventoryCategory"]').on('shown.bs.modal', function () {
            const modalId = this.id.replace('editInventoryCategory', '');
            const colorSelect = document.getElementById('colorSelect' + modalId);
            const colorPreview = document.getElementById('colorPreview' + modalId);
