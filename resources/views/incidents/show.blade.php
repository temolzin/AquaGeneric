                            ...
                            <div class="col-lg-12 text-center mt-4">
                                @if($incident->getMedia('incidentImages')->count())
                                    @foreach ($incident->getMedia('incidentImages') as $media)
                                        <img src="{{ $media->getUrl() }}?v={{ time() }}" alt="Imagen incidencia" class="img-thumbnail m-1" style="max-width: 150px; cursor:pointer;"
                                            ...
                                            <div class="modal-dialog modal-dialog-centered" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body text-center">
                                                        <img src="{{ $media->getUrl() }}?v={{ time() }}" alt="Imagen incidencia" class="img-fluid rounded" style="max-height: 500px;">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
