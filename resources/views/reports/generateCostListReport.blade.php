            ...
            <table id="detailedReport">
                <thead>
                    <tr>
                        ...
                        <th class="textable">PRECIO</th>
                </thead>
                <tbody id="statusDetails">
                    @foreach ($costs as $cost)
                        <tr>
                            <td class="textcenter">{{ $cost->id }}</td>
                            <td class="textcenter">{{ $cost->category }}</td>
                            <td class="textcenter">{{ $cost->description }}</td>
                            <td class="textcenter">{{ $cost->price }}</td>
                        </tr>
                    @endforeach
                </tbody>
            </table>
