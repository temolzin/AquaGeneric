...
<body>
                ...
                <td>
                    <div class="logo">
                        @if ($authUser->locality->hasMedia('localityGallery'))
                            <img src="{{ $authUser->locality->getFirstMediaUrl('localityGallery') }}" alt="Foto de {{ $authUser->locality->name }}">
                        @else
                            <img src="img/localityDefault.png" alt="Foto por defecto">
                        @endif
                    </div>
                </td>
        ...
        <table id="reporte_detalle">
            <thead>
                <tr>
                    ...
                    <th class="textable">CATEGORÍA</th>
                    <th class="textable">MATERIAL</th>
                    <th class="textable">DIMENSIONES</th>
                </tr>
            </thead>
    ...
    <div class="info_Eabajo">
        ...
        <img src="img/rootheim.png" width="20px" height="15px">
    </div>
</body>
</html>