                            ...
                            <table id="report_header" style="width: 100%;">
                                <tr>
                                    ...
                                    <td class="report_info">
                                        <div class="round">
                                            <span class="h3">Reporte Anual de Pagos</span>
                                            <p class="quarter_info"><strong>Fecha: </strong>{{ \Carbon\Carbon::now()->translatedFormat('j \d\e F \d\e Y') }}</p> 
                                            <p class="quarter_info"><strong>Año: </strong>{{ $year }}</p>
                                            <p class="quarter_info"><strong>Cliente: </strong>{{ $customer->name }} {{ $customer->last_name }}</p>
                                        </div>
                                    </td>
                                </tr>
                            </table>
                    ...
                    <table id="report_detail" class="consecutive_table">
                        ...
                        <tbody id="product_detail">
                            ...
                            @if(count($waterConnectionData['payments']) > 0)
                                ...
                                @endforeach
                                <tr>
                                    <td colspan="3" class="total_payment"><strong>Total pagado por la toma {{ $waterConnectionData['water_connection']->name }} en {{ $year }}:</strong></td>
                                    <td class="text_center"><strong>$ {{ number_format($subtotalConnection, 2) }}</strong></td>
                                </tr>
                            @else
                                <tr>
                                    <td colspan="4" class="text_center">No hay pagos registrados para esta toma en el año {{ $year }}</td>
                                </tr>
                            @endif
                        </tbody>
                    </table>
