                        ...
                        <div class="round">
                            ...
                            <table class="datos_cliente">
                                <tr>
                                    ...
                                    <td><label>Total Adelantado:</label> <p>${{ number_format($debt->amount_due, 2) }}</p></td>
                                </tr>
                            </table>
                        </div>
                    </td>
                    ...
                    <tr>
                        @for ($i = 0; $i < 2; $i++)
                            <td style="padding: 8px; text-align: center; width: 50%;">
                                <img src="file://{{ $imagePaths[$i] }}" style="max-width: 100%; height: auto;" />
                            </td>
                        @endfor
                    </tr>
                    <tr>
                        <td colspan="2" style="padding: 8px; text-align: center;">
                            <img src="file://{{ $imagePaths[2] }}" style="max-width: 100%; height: auto;" />
                        </td>
                    </tr>
                </tbody>
            </table>  
