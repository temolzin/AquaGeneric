...
<div class="report-page">
    ...
    <div class="page-content">
        <div class="page-inner">
            <div class="first-page-header">
                ...
                <div class="first-page-title-block">
                    <p class="first-page-title">
                        COMITÉ DEL SISTEMA DE AGUA POTABLE DE
                        {{ $authUser->locality->name }},
                        {{ $authUser->locality->municipality }},
                        {{ $authUser->locality->state }}
                    </p>
                    <p class="first-page-subtitle">
                        LISTA DE DESCUENTOS
                    </p>
                </div>
            </div>
            <table class="report-table">
                ...
                <tbody>
                    @foreach ($firstPageDiscounts as $discount)
                        <tr>
                            <td>
                                {{ $discount->id }}
                            </td>
    ...
    <div class="report-footer">
        ...
        <span class="text_infoE page-number">
            Página 1 de {{ $totalPages }}
        </span>
        <span class="text_infoE"> | </span>
        <a class="text_infoE footer-branding" href="https://rootheim.com/">
...
@foreach ($otherPagesDiscounts as $pageDiscounts)
<div class="report-page page-break">
    ...
    <div class="page-content">
        <div class="page-inner">
            <div class="inner-page-header">
                ...
                <tbody>
                    @foreach ($pageDiscounts as $discount)
                        <tr>
                            <td>
                                {{ $discount->id }}
                            </td>
    ...
    <div class="report-footer">
        ...
        <span class="text_infoE"> | </span>
        <span class="text_infoE page-number">
            Página {{ $loop->iteration + 1 }} de {{ $totalPages }}
        </span>
        <span class="text_infoE"> | </span>
        <a class="text_infoE footer-branding" href="https://rootheim.com/">
            powered by<strong> Root Heim Company </strong>
