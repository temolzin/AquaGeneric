...
<html>
    <head>
        <title>Reporte de Empleados por Rol</title>
        <style>
            html {
                margin: 0;
                padding: 15px;
    ...
    <body>
        <div id="pdfPage">
            ...
            <div class="title">
                <h3>LISTA DE EMPLEADOS - ROL: {{ strtoupper($role) }}</h3>
            </div>
            <table id="detailedReport">
                <thead>
                    <tr>
                        ...
                        <th class="textable">EMAIL</th>
                        <th class="textable">TELÉFONO</th>
                        <th class="textable">LOCALIDAD</th>
                        <th class="textable">SALARIO</th>
                    </tr>
                </thead>
                <tbody id="employeeDetails">
                    @forelse($employees as $employee)
                        <tr>
                            ...
                            <td class="textcenter">${{ number_format($employee->salary, 2) }}</td>
                        </tr>
                    @empty
                        <tr>
                            <td colspan="6" class="textcenter">No hay empleados con este rol</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
