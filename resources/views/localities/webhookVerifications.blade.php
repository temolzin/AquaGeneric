...
@section('content_header')
    <div class="d-flex justify-content-between align-items-center">
        ...
        <div>
            ...
            <a href="{{ route('localities.index') }}" class="btn btn-secondary">
                <i class="fas fa-arrow-left"></i> Volver a Localidades
            </a>
        </div>
    </div>
@endsection
                                ...
                                <tbody>
                                    @foreach($verifications as $verification)
                                        <tr data-id="{{ $verification->id }}">
                                            ...
                                            <td>
                                                <small class="text-muted">{{ $verification->ip_address ?? '-' }}</small>
                                            </td>
                                            <td>
                                                <button type="button" class="btn btn-success btn-sm btn-copy" 
                                                    data-code="{{ $verification->verification_code }}"
                                                    title="Copiar código">
                ...
                <div class="card-body">
                    ...
                    <div class="input-group">
                        <input type="text" class="form-control" id="webhook-url" 
                            value="{{ route('openpay.webhook') }}" readonly>
