                            ...
                            <div class="col-lg-12">
                                <div class="d-lg-flex justify-content-between align-items-center flex-wrap">
                                    ...
                                    <div class="btn-group d-none d-md-flex" role="group" aria-label="Acciones de Cliente">
                                        ...
                                        <a type="button" class="btn btn-secondary" target="_blank" title="Generar Lista" href="{{ route('customers.pdfCustomers', ['search' => request('search')]) }}">
                                            <i class="fas fa-file-pdf"></i> Generar Lista
                                        </a>
                                        <a type="button" class="btn btn-secondary" target="_blank" title="Generar Lista Resumen" href="{{ route('customers.pdfCustomersSummary', ['search' => request('search')]) }}">
