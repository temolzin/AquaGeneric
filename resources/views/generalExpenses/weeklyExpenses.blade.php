    ...
    <div class="modal-dialog modal-sm" role="document">
        <div class="modal-content">
            <div class="modal-header modal-header-custom bg-olive">
                <h5 class="modal-title" id="weeklyExpensesLabel">Selecciona un Periodo de Fechas</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <form id="weeklyExpensesForm" method="GET" action="{{ route('report.weeklyExpensesReport') }}" target="_blank">
