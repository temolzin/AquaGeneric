                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" disabled class="form-control" value="{{ \Carbon\Carbon::parse($incident->start_date)->format('d/m/Y') }}" />
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <div class="form-group">
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" disabled class="form-control" value="{{ $incident->incidentCategory->name ?? 'Sin categoría' }}" />
                                    </div>
                                </div>
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <label>Reportado por</label>
                                        <input type="text" disabled class="form-control" value="{{ $incident->creator->name ?? '' }} {{ $incident->creator->last_name ?? '' }}" />
                                    </div>
                                </div>
                            </div>
