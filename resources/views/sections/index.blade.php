                        ...
                        <div class="col-lg-12">
                            <div class="d-lg-flex justify-content-between align-items-center flex-wrap">
                                ...
                                <div class="btn-group d-none d-md-flex" role="group" aria-label="Acciones de Sección">
                                    <button class="btn btn-success mr-2" data-toggle='modal' data-target="#createSection" title="Registrar Sección">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="btn-group" role="group" aria-label="Opciones">
                                                        ...
                                                        @endcan
                                                        @can('deleteSections')
                                                            <button type="button" class="btn {{ $section->hasDependencies() ? 'btn-secondary' : 'btn-danger' }} mr-2" title="{{ $section->hasDependencies() ? 'Eliminación no permitida: esta sección tiene tomas asociadas.' : 'Eliminar Sección' }}"
