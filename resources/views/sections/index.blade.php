                                ...
                                <div class="d-md-none w-100">
                                    <div class="row g-2">
                                        ...
                                        <div class="col-6 ps-1">
                                            <button class="btn btn-secondary w-100 py-2" data-toggle="modal" data-target="#pdfSectionModal" title="Generar Lista">
                                    ...
                                    <tbody>
                                        @forelse($sections as $section)
                                            <tr>
                                                <td>{{ $section->id }}</td>
                                                <td>
                                                    <span class="badge" style="background-color: {{ $section->color ?? '#6c757d' }}; color: white;">
                                                        {{ $section->name }}
                                                    </span>
                                                </td>
