...
class RolesAndPermissionsSeeder extends Seeder
{
    public function run()
    {
        ...
        Permission::firstOrCreate([
            'name' => 'viewDiscount',
            'description' => 'Permite ver los Descuentos.'
        ])->assignRole([$roleSupervisor, $roleSecretariat]);
        Permission::firstOrCreate([
            'name' => 'createDiscount',
            'description' => 'Permite crear los Descuentos.'
        ])->assignRole([$roleSupervisor]);
        Permission::firstOrCreate([
            'name' => 'editDiscount',
            'description' => 'Permite editar los Descuentos.'
        ])->assignRole([$roleSupervisor]);
        Permission::firstOrCreate([
            'name' => 'deleteDiscount',
        ...
        Permission::firstOrCreate([
            ...
            'description' => 'Permite ver las Categorías de Deudas.'
        ])->assignRole([$roleSupervisor, $roleSecretariat]);
        Permission::firstOrCreate([
            'name' => 'createDebtCategories',
            'description' => 'Permite crear Categorías de Deudas.'
        ])->assignRole([$roleSupervisor, $roleSecretariat]);
        Permission::firstOrCreate([
            'name' => 'editDebtCategories',
            'description' => 'Permite editar Categorías de Deudas.'
        ])->assignRole([$roleSupervisor]);
        Permission::firstOrCreate([
            'name' => 'deleteDebtCategories',
            'description' => 'Permite eliminar Categorías de Deudas.'
        ])->assignRole([$roleSupervisor]);
        Permission::firstOrCreate([
        ...
        Permission::firstOrCreate([
            'name' => 'deleteEarningTypes',
            'description' => 'Permite eliminar los tipos de ingresos.'
        ])->assignRole($roleSupervisor, $roleSecretariat);
        Permission::firstOrCreate([
            'name' => 'editEarningTypes',
            'description' => 'Permite editar los tipos de ingresos.'
        ])->assignRole($roleSupervisor, $roleSecretariat);
        Permission::firstOrCreate([
